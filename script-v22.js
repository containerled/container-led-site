...
// Aviso informativo de privacidade
const privacyBanner = document.getElementById('privacy-banner');
const privacyAccept = document.getElementById('privacy-accept');
if (privacyBanner && !localStorage.getItem('containerLedPrivacyNotice')) privacyBanner.hidden = false;
if (privacyAccept) privacyAccept.addEventListener('click', () => {
  localStorage.setItem('containerLedPrivacyNotice', 'acknowledged');
